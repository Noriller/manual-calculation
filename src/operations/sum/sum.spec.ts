...
describe('sum', () => {
  ...
  it('adds 123456789.132456789 + 0.000000001 to equal 123456789132456790', () => {
    expect(Sum('123456789.132456789', '0.000000001')).toStrictEqual(
      '123456789.13245679',
    );
  });
  ...
  it('adds 123456789.132456789 + 999999999.999999999 + 987654321.987654321 to equal 2111111111.120111109', () => {
    expect(
      Sum('123456789.132456789', '999999999.999999999', '987654321.987654321'),
    ).toStrictEqual('2111111111.120111109');
  });

  it('adds 12345678913245678.9 + 9999999999999999.99 + 987654321987654.321 to equal 2111111111120111109', () => {
    expect(
      Sum('12345678913245678.9', '9999999999999999.99', '987654321987654.321'),
    ).toStrictEqual('23333333235233333.211');
  });
  ...
  it('adds -123.456 + -23456.7 + -3.45678 to equal -23583.61278', () => {
    expect(Sum('-123.456', '-23456.7', '-3.45678')).toStrictEqual(
      '-23583.61278',
    );
  });
